...
# === 1. 读取数据 ===
shp_path = r"D:\EcoSci\Dr.Shi\Data\wammaogou_landuse\wammaogou_boundary.shp"
gdf = gpd.read_file(shp_path)

resampled_csv_path = r"D:\EcoSci\Dr.Shi\Data\resampled_Loess_Plateau_wangmaogou_1km_with_DEM.csv"
grid_df = pd.read_csv(resampled_csv_path)

dam_xls_path = r"D:\EcoSci\Dr.Shi\Data\wangmaogou_dams.xlsx"
...
# 7.1 保存更新后的堤坝数据到 CSV
dam_output_csv = r"D:\EcoSci\Dr.Shi\Data\wangmaogou_Dam_data_with_matched_points.csv"
df_dams.to_csv(dam_output_csv, index=False, encoding='utf-8-sig')
print(f"堤坝匹配结果已保存至: {dam_output_csv}")

# 7.2 保存更新后的网格数据带有 Region 列
grid_output_csv = r"D:\EcoSci\Dr.Shi\Data\resampled_Loess_Plateau_wangmaogou_1km_with_DEM_region_labeled.csv"
