...
for year in years:
    ...
    for month_index in range(n_months):
        ...
        mask1 = ((converted_total >= 0.055/30) & (converted_total <= 0.065/30))
        mask2 = ((converted_total >= 0.085/30) & (converted_total <= 0.095/30))
        mask3 = ((converted_total >= 0.115/30) & (converted_total <= 0.125/30))
