...
# Define paths
data_dir = "D:\\EcoSci\\Dr.Shi\\Data\\ERA5\\Download\\ERA5_Data_Monthly"  # Directory containing .nc files
csv_file = "D:\\EcoSci\\Dr.Shi\\Data\\resampled_Loess_Plateau_1km_with_DEM_region_k1k2_labeled.csv"  # CSV file path
output_dir = "D:\\EcoSci\\Dr.Shi\\Data\\ERA5\\Download\\ERA5_Data_Monthly_Resampled"  # Output directory
...
for year in range(start_year, end_year + 1):
    nc_file = os.path.join(data_dir, f"{year}.nc")  # Construct file path
