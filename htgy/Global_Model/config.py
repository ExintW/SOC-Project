...
C_INIT_CAP = 1e9             # Cap initial SOC to this value (0 to disable)
...
USE_TIKHONOV = False        # Enable L2 Regularization
PAST_KNOWN = 2012               # Year of 1 known SOC data in the past
REG_FREQ = 1                # Frequency (in years) to apply spatial regularization
...
RIVERS_SHP = None
LAI_PAST_FILE = Paths.DATA_DIR / "CMIP6" / "lai_Lmon_BCC-CSM2-HR_hist-1950_r1i1p1f1_gn_200101-201412.nc"  # NetCDF file containing resampled LAI data for past years
...
CMIP6_LAI_SEGMENTS = [      # Specify segments of CMIP6 LAI data files covering different time periods
    {
        ...
        "end_year": 2000,
        "cmip_start": 1950,
        "relpath": Paths.DATA_DIR / "CMIP6" / "lai_Lmon_BCC-CSM2-HR_hist-1950_r1i1p1f1_gn_195001-200012.nc",
    },
    {
        "start_year": 2001,
        "end_year": 2014,
        "cmip_start": 2001,
        "relpath": Paths.DATA_DIR / "CMIP6" / "lai_Lmon_BCC-CSM2-HR_hist-1950_r1i1p1f1_gn_200101-201412.nc",
    },
    {
        "start_year": 2015,
        "end_year": None,  # open-ended
        "cmip_start": 2015,
        "relpath": Paths.DATA_DIR / "CMIP6" / "lai_Lmon_BCC-CSM2-MR_ssp245_r1i1p1f1_gn_201501-210012.nc",
    },
]
